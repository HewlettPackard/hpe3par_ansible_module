...
import mock
import unittest
from Modules import hpe3par_online_clone
...
class TestHpe3parOnlineClone(unittest.TestCase):
    ...
    @mock.patch('Modules.hpe3par_online_clone.AnsibleModule')
    ...
    @mock.patch('Modules.hpe3par_online_clone.client')
    @mock.patch('Modules.hpe3par_online_clone.AnsibleModule')
    @mock.patch('Modules.hpe3par_online_clone.create_online_clone')
    ...
    @mock.patch('Modules.hpe3par_online_clone.client')
    @mock.patch('Modules.hpe3par_online_clone.AnsibleModule')
    @mock.patch('Modules.hpe3par_online_clone.delete_clone')
    ...
    @mock.patch('Modules.hpe3par_online_clone.client')
    @mock.patch('Modules.hpe3par_online_clone.AnsibleModule')
    @mock.patch('Modules.hpe3par_online_clone.resync_clone')
