...
import mock
import unittest
from Modules import hpe3par_offline_clone
...
class TestHpe3parOfflineClone(unittest.TestCase):
    ...
    @mock.patch('Modules.hpe3par_offline_clone.client')
    @mock.patch('Modules.hpe3par_offline_clone.AnsibleModule')
    ...
    @mock.patch('Modules.hpe3par_offline_clone.client')
    @mock.patch('Modules.hpe3par_offline_clone.AnsibleModule')
    @mock.patch('Modules.hpe3par_offline_clone.create_offline_clone')
    ...
    @mock.patch('Modules.hpe3par_offline_clone.client')
    @mock.patch('Modules.hpe3par_offline_clone.AnsibleModule')
    @mock.patch('Modules.hpe3par_offline_clone.delete_clone')
    ...
    @mock.patch('Modules.hpe3par_offline_clone.client')
    @mock.patch('Modules.hpe3par_offline_clone.AnsibleModule')
    @mock.patch('Modules.hpe3par_offline_clone.resync_clone')
    ...
    @mock.patch('Modules.hpe3par_offline_clone.client')
    @mock.patch('Modules.hpe3par_offline_clone.AnsibleModule')
    @mock.patch('Modules.hpe3par_offline_clone.stop_clone')
    ...
    @mock.patch('Modules.hpe3par_offline_clone.client')
    def test_create_offline_clone(self, mock_client):
...
null", {}))
    ...
    def test_resync_clone(self, mock_client):
        mock_client.HPE3ParClient.login.return_value = True
        self.assertEqual(hpe3par_offline_clone.resync_clone(mock_client.HPE3ParClient,
                                                            'USER',
                                                            'PASS',
                                                            'test_clone'
    ...
    @mock.patch('Modules.hpe3par_offline_clone.client')
    def test_stop_clone(self, mock_client):
        mock_client.HPE3ParClient.login.return_value = True
        mock_client.HPE3ParClient.setSSHOptions.return_value = True
        ...
        self.assertEqual(hpe3par_offline_clone.stop_clone(mock_client.HPE3ParClient,
                                                          '192.168.0.1',
                                                          'USER',
                                                          'PASS',
                                                          'test_clone',
    ...
    def test_delete_clone(self, mock_client):
        ...
        self.assertEqual(hpe3par_offline_clone.delete_clone(mock_client.HPE3ParClient,
                                                            '192.168.0.1',
                                                            'USER',
                                                            'PASS',
                                                            'test_clone',
