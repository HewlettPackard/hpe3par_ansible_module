...
import mock
from Modules import hpe3par_volumeset as volumeset
...
class TestHpe3parvolumeset(unittest.TestCase):
    ...
    @mock.patch('Modules.hpe3par_volumeset.client')
    @mock.patch('Modules.hpe3par_volumeset.AnsibleModule')
    ...
    @mock.patch('Modules.hpe3par_volumeset.client')
    @mock.patch('Modules.hpe3par_volumeset.AnsibleModule')
    @mock.patch('Modules.hpe3par_volumeset.create_volumeset')
...
# Create volumeset
    ...
    @mock.patch('Modules.hpe3par_volumeset.client')
    @mock.patch('Modules.hpe3par_volumeset.AnsibleModule')
    @mock.patch('Modules.hpe3par_volumeset.delete_volumeset')
    def test_main_exit_functionality_success_without_issue_attr_dict_present(self, mock_volumeset, mock_module, mock_client):
        """
        hpe3par volumeset - success check
        """
    ...
    @mock.patch('Modules.hpe3par_volumeset.client')
    @mock.patch('Modules.hpe3par_volumeset.AnsibleModule')
    @mock.patch('Modules.hpe3par_volumeset.add_volumes')
    ...
    @mock.patch('Modules.hpe3par_volumeset.client')
    @mock.patch('Modules.hpe3par_volumeset.AnsibleModule')
    @mock.patch('Modules.hpe3par_volumeset.remove_volumes')
