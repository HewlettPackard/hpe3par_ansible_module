...
import mock
import unittest
from Modules import hpe3par_volume
...
class TestHpe3parVolume(unittest.TestCase):
    ...
    @mock.patch('Modules.hpe3par_volume.AnsibleModule')
    ...
    @mock.patch('Modules.hpe3par_volume.client')
    @mock.patch('Modules.hpe3par_volume.AnsibleModule')
    @mock.patch('Modules.hpe3par_volume.delete_volume')
    ...
    @mock.patch('Modules.hpe3par_volume.client')
    @mock.patch('Modules.hpe3par_volume.AnsibleModule')
    @mock.patch('Modules.hpe3par_volume.modify_volume')
    ...
    @mock.patch('Modules.hpe3par_volume.client')
    @mock.patch('Modules.hpe3par_volume.AnsibleModule')
    @mock.patch('Modules.hpe3par_volume.grow')
    ...
    @mock.patch('Modules.hpe3par_volume.client')
    @mock.patch('Modules.hpe3par_volume.AnsibleModule')
    @mock.patch('Modules.hpe3par_volume.grow_to_size')
    ...
    @mock.patch('Modules.hpe3par_volume.client')
    @mock.patch('Modules.hpe3par_volume.AnsibleModule')
    @mock.patch('Modules.hpe3par_volume.change_snap_cpg')
    ...
    @mock.patch('Modules.hpe3par_volume.client')
    @mock.patch('Modules.hpe3par_volume.AnsibleModule')
    @mock.patch('Modules.hpe3par_volume.change_user_cpg')
    ...
    @mock.patch('Modules.hpe3par_volume.client')
    @mock.patch('Modules.hpe3par_volume.AnsibleModule')
    @mock.patch('Modules.hpe3par_volume.convert_type')
