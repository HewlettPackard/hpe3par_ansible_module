...
import mock
from Modules import hpe3par_flash_cache as flash_cache
...
class TestHpe3parFlashCache(unittest.TestCase):
    ...
    @mock.patch('Modules.hpe3par_flash_cache.client')
    @mock.patch('Modules.hpe3par_flash_cache.AnsibleModule')
    ...
    @mock.patch('Modules.hpe3par_flash_cache.client')
    @mock.patch('Modules.hpe3par_flash_cache.AnsibleModule')
    @mock.patch('Modules.hpe3par_flash_cache.create_flash_cache')
...
# Create
    ...
    def test_create_flash_cache_create_exception_in_login(self, mock_client):
        ...
        result = flash_cache.create_flash_cache(mock_client.HPE3ParClient, "user", "password", 1024, None)
...
# Delete
    ...
    def test_delete_flash_cache_create_exception_in_login(self, mock_client):
        ...
        """
        mock_client.HPE3ParClient.login.side_effect = Exception("Failed to login!")
        result = flash_cache.delete_flash_cache(mock_client.HPE3ParClient, "user", "password")
