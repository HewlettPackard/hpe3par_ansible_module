...
import mock
from Modules import hpe3par_qos as qos
...
class TestHpe3parQos(unittest.TestCase):
    ...
    @mock.patch('Modules.hpe3par_qos.client')
    @mock.patch('Modules.hpe3par_qos.AnsibleModule')
    ...
    @mock.patch('Modules.hpe3par_qos.client')
    @mock.patch('Modules.hpe3par_qos.AnsibleModule')
    @mock.patch('Modules.hpe3par_qos.create_qos_rule')
...
# Create
    ...
    def test_create_qos_rule_create_already_present(self, mock_client):
        ...
        hpe3par qos - create a qos rule
        """
        result = qos.create_qos_rule(mock_client, "user", "password", 'qos_tgt', None, None, None,
    ...
    def test_create_qos_rule_create_exception_in_login(self, mock_client):
        ...
        result = qos.create_qos_rule(mock_client.HPE3ParClient, "user", "password", 'qos_tgt_name', None, None,
    ...
    def test_create_qos_rule_create_sucess_login(self, mock_client):
        ...
        mock_client.HPE3ParClient.return_value = mock_client
        result = qos.create_qos_rule(mock_client.HPE3ParClient, "user", "password", 'qos_tgt_name', 'vvset',
    ...
    def test_create_qos_rule_create_sucess_login_latency_goal_latency_goal_usecs(self, mock_client):
        ...
        mock_client.HPE3ParClient.qosRuleExists.return_value = False
        mock_client.HPE3ParClient.return_value = mock_client
        result = qos.create_qos_rule(mock_client.HPE3ParClient, "user", "password", 'qos_tgt_name', None,
...
# Delete
    ...
    def test_delete_qos_rule_create_exception_in_login(self, mock_client):
        ...
        mock_client.HPE3ParClient.login.side_effect = Exception("Failed to login!")
        mock_client.HPE3ParClient.return_value = mock_client
        result = qos.delete_qos_rule(mock_client.HPE3ParClient, "user", "password", 'qos_tgt_name', None)
...
# Modify
    ...
    def test_modify_qos_rule_create_already_present(self, mock_client):
        ...
        hpe3par qos - modify a qos rule
        """
        result = qos.modify_qos_rule(mock_client, "user", "password", 'qos_tgt_name', None, None, None,
                                     None, None, None, None, None, None, None, None, None, None, None)
    ...
    def test_modify_qos_rule_create_exception_in_login(self, mock_client):
        ...
        mock_client.HPE3ParClient.login.side_effect = Exception("Failed to login!")
        mock_client.HPE3ParClient.return_value = mock_client
        result = qos.modify_qos_rule(mock_client.HPE3ParClient, "user", "password", 'qos_tgt_name', None, None,
                                     None, None, None, None, None, None, None, None, None, None, None, None)
    ...
    @mock.patch('Modules.hpe3par_qos.client')
    def test_construct_qos_rules_map_priority(self, mock_client):
        """
    ...
    @mock.patch('Modules.hpe3par_qos.client')
    def test_construct_qos_rules_map_bwMinGoalOP(self, mock_client):
        """
        hpe3par qos - construct_qos_rules
        """
        mock_client.HPE3ParClient.QOSPriority.LOW = 1
    ...
    @mock.patch('Modules.hpe3par_qos.client')
    def test_construct_qos_rules_map_bwMaxLimitOP(self, mock_client):
        """
        hpe3par qos - construct_qos_rules
        """
        mock_client.HPE3ParClient.QOSPriority.LOW = 1
    ...
    @mock.patch('Modules.hpe3par_qos.client')
    def test_construct_qos_rules_map_iomin_goal_op(self, mock_client):
        """
        hpe3par qos - construct_qos_rules
        """
        mock_client.HPE3ParClient.QOSPriority.LOW = 1
    ...
    @mock.patch('Modules.hpe3par_qos.client')
    def test_construct_qos_rules_map_iomax_limit_op(self, mock_client):
        """
        hpe3par qos - construct_qos_rules
        """
        mock_client.HPE3ParClient.QOSPriority.LOW = 1
    ...
    @mock.patch('Modules.hpe3par_qos.client')
    @mock.patch('Modules.hpe3par_qos.AnsibleModule')
    @mock.patch('Modules.hpe3par_qos.delete_qos_rule')
    ...
    @mock.patch('Modules.hpe3par_qos.client')
    @mock.patch('Modules.hpe3par_qos.AnsibleModule')
    @mock.patch('Modules.hpe3par_qos.modify_qos_rule')
