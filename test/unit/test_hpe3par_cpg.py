...
import mock
import unittest
from Modules import hpe3par_cpg
...
class TestHpe3parCPG(unittest.TestCase):
    ...
    @mock.patch('Modules.hpe3par_cpg.client')
    @mock.patch('Modules.hpe3par_cpg.AnsibleModule')
    ...
    @mock.patch('Modules.hpe3par_cpg.client')
    @mock.patch('Modules.hpe3par_cpg.AnsibleModule')
    @mock.patch('Modules.hpe3par_cpg.create_cpg')
    ...
    @mock.patch('Modules.hpe3par_cpg.client')
    @mock.patch('Modules.hpe3par_cpg.AnsibleModule')
    @mock.patch('Modules.hpe3par_cpg.delete_cpg')
